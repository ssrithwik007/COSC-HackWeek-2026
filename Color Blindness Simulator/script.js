let selectedBlindness = "Protanopia";
...
const achromatopsiaBtn = document.getElementById("achromatopsiaBtn");
...
const blindnessBtns = {
    "Protanopia": protanopiaBtn,
    "Deuteranopia": deuteranopiaBtn,
    "Tritanopia": tritanopiaBtn,
    "Achromatopsia": achromatopsiaBtn,
}
const matrices = {
    Protanopia: [
        [
    ...
    Achromatopsia: [
        ...
        [
            [0.9299, 0.0585, 0.0116],
            [0.2299, 0.7585, 0.0116],
            [0.2299, 0.0585, 0.7116]
        ],
        [
            [0.8598, 0.1170, 0.0228],
            [0.2598, 0.7170, 0.0228],
            [0.2598, 0.1170, 0.6228]
        ],
        [
            [0.7897, 0.1755, 0.0348],
            [0.2897, 0.6755, 0.0348],
            [0.2897, 0.1755, 0.5348]
        ],
        [
            [0.7196, 0.2340, 0.0464],
            [0.3196, 0.6340, 0.0464],
            [0.3196, 0.2340, 0.4464]
        ],
        [
            [0.6495, 0.2925, 0.0580],
            [0.3495, 0.5925, 0.0580],
            [0.3495, 0.2925, 0.3580]
        ],
        [
            [0.5794, 0.3510, 0.0696],
            [0.3794, 0.5510, 0.0696],
            [0.3794, 0.3510, 0.2696]
        ],
        [
            [0.5093, 0.4095, 0.0812],
            [0.4093, 0.5095, 0.0812],
            [0.4093, 0.4095, 0.1812]
        ],
        [
            [0.4392, 0.4680, 0.0928],
            [0.4392, 0.4680, 0.0928],
            [0.4392, 0.4680, 0.0928]
        ],
        [
            [0.3691, 0.5265, 0.1044],
            [0.3691, 0.5265, 0.1044],
            [0.3691, 0.5265, 0.1044]
        ],
        [
...
Object.entries(blindnessBtns).forEach(([type, button]) => {
    if(button) {
...
resetBtn.addEventListener("click", () => {
    ...
    selectedBlindness = "Protanopia";
    imageHeading.textContent = selectedBlindness;

    Object.values(blindnessBtns).forEach(btn =>
...
function simulate(type){
    simulatedCanvas = document.createElement("canvas");
    simulatedCtx = simulatedCanvas.getContext("2d");
    simulatedCanvas.width = uploadedImage.naturalWidth;
    simulatedCanvas.height = uploadedImage.naturalHeight;
    simulatedCanvas.classList.add("w-full", "h-auto", "object-contain", "rounded-3xl");
    ...
    colorBlind.innerHTML = "";
    colorBlind.appendChild(simulatedCanvas);
}
...
dropZone.addEventListener("dragover", (event) => {
    ...
    dropZone.classList.add("border-text");
});
